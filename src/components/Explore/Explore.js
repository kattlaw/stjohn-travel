...
const Explore = () => {
    ...
    useEffect(() => {
          ...
          let ctx = gsap.context(() => {
             ...
             gsap.from([lineTwo.current, lineThree.current], {
                scrollTrigger: {
                    trigger:"#explore",
                    start: "top bottom",
                    end:"+=500",
        ...
        //GSAP turtle animation w/ mouse movement
    ...
    return (
        <section id="explore">
                <div className="section-explore-header">
                    ...
                    <h5 ref={lineTwo}>the beauty and awe of St. John, </h5>
                    <h5 className="bottom-line" ref={lineThree}>where a tropical mecca awaits</h5>
                </div>
                ...
                <div className="explore-bottom-container" id="explore-bottom">
                    <img src={seaturtle} className="sea-turtle" alt="seaturtle" ref={turtleRef}></img>
                    <img src={water} className="water" alt="water"></img>
                </div>
        </section>
    ) 
}
